...
-  [Plots.jl](https://docs.juliaplots.org/latest/) is Julia's most popular plotting package. Its recipe system leads to `plot(sol)` automatically knowing how to visualize ODE solutions—perfect for our simulations. 
...
In this post, we looked at how to simulate Raman amplifiers using Julia. We then tried to optimise out code for performance and finally compared our Julia code with the Python implemetation.
 
In this post, I have simulated for the co-pumped and single Raman shift based amplifier. In subsequent posts, I’ll explore multiple Raman shifts and also counter-pumped case.
